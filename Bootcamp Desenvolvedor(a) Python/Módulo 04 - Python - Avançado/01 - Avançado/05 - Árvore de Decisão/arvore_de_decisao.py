...
# Importância das características(features) na classificação
print(f"\nImportância de cada feature: {model_DTC.feature_importances_}")



# Classes previstas pela árvore de decisão
print(f"\nClasses previstas: {model_DTC.classes_}")


      
# Defina as variáveis de previsão
previsores: List[str] = ['historia', 'divida', 'garantias', 'renda']

# Crie uma figura e um eixo para plotar a árvore de decisão
figura, eixos = plt.subplots(nrows=1, ncols=1, figsize=(10, 10))

# Plote a árvore de decisão com características e classes
